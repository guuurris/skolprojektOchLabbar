...
<xsl:template match="category[@position = 'center' and @site = 'addCategory']">
	<div id="colTwo">
		...
		<form name="prenumerate" action="?site=addCategory" method="post" id="prenumform">
			...
			<!-- TODO: Lagg till stt det skrivs ut i tva kolumner, if sats finns i templaten -->
				...
				<div class="rightcolumn" style="margin-right:55px;">
					...
					<div style="width:100%;" class="mobile">
						<br/><p class="input_button" align="right"><input type="submit" value="Skicka" /></p>
					</div>
				</div>
			<div style="clear: both;"/>
			</div>
	...
	<div id="colTwo">
		...
		<div style="float:right;">
			...
			<p class="input_button">
				...
				<input name="changeRecipe" type="submit" method="post" value="Ã¤ndra"/> </form> <form action="?site=showRecipe" method="post"> <input name="saveRecipe" type="submit" value="Spara Recept" /> </form>
